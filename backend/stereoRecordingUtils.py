...
class StereoRecordingManager:
    ...
    def stereoGSTCompositedVideoCommand(self, leftCameraDevicePath, rightCameraDevicePath, cameraFrameWidth, cameraFramerate, outputDirectory, filename):
        ...
        command = (
            ...
            f"v4l2src device=/dev/video{leftCameraDevicePath} ! image/jpeg,width={cameraFrameWidth},framerate={cameraFramerate}/1 ! "
            "jpegdec ! videorate ! queue2 ! mix.sink_0 "
            f"v4l2src device=/dev/video{rightCameraDevicePath} ! image/jpeg,width={cameraFrameWidth},framerate={cameraFramerate}/1 ! "
