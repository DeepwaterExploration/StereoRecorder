...
const StitchedComponent: React.FC<Stitchedprops> = (props) => {
    ...
    const validFPS = props.leftOptions.fps.filter((n) => props.rightOptions.fps.includes(n))
    const validWidth = props.leftOptions.width.filter((n) => props.rightOptions.width.includes(n))
